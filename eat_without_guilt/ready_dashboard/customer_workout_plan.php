...
<?php
    /***** Fetch Customer Workout plan *****/
    $curl = curl_init();

    curl_setopt_array($curl, array(
      CURLOPT_URL => $api_endpoint."api/v1/fetch-customer-workout/",
    ...
    $err = curl_error($curl);
    curl_close($curl);
    $fetch_workout_plan =  json_decode($response, true);
    /****** Customer workout days ******/
    $curl = curl_init();

    curl_setopt_array($curl, array(
      CURLOPT_URL => $api_endpoint."api/v1/fetch-customer-workout-days/",
      // CURLOPT_SSL_VERIFYPEER => true,
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
    ...
    $err = curl_error($curl);
    curl_close($curl);
    $customer_workout_plan =  json_decode($response, true);
        ...
        <!-- BEGIN Page Wrapper -->
            <?php include 'navbar.php';?>
                  <main id="js-page-content" role="main" class="page-content">
                    <div class="panel-hdr">
                        <h2>
                          My Workout Plan  <span class="fw-300"><i> <?php // echo  $customer_workout_plan['data']['PlanName'] ?> </i></span>
                        </h2>

                        <h2>
                          Created By :  <?php echo  $customer_workout_plan['data']['CreatedBy'] ?>
                        </h2>

                        <h2>
                          Assigned On : <?php echo  $customer_workout_plan['data']['AssignedDate'] ?>
                        </h2>
                    ...
                    <div id="panel-9" class="panel">
                      <div class="panel-container show">
                          <div class="panel-content">
                              ...
                              <div class="row">
                              <?php
                              foreach($customer_workout_plan['data']['CustomerWorkoutData'] as $plan) { ?>
                              <div class="col-md-12">
                                <div class="card border mb-g">
                                    <div class="card-header bg-danger-700 pr-3 d-flex align-items-center flex-wrap">
                                        <div class="card-title"> Day <?php echo $plan['DaysCount'] ?> - Your preferred day is <?php echo $plan['DayOfWeek'] ?> </div>
                                        <a href="customer_workout_exercise.php?CustomerUserId=<?php echo $cust_user_id ?>&CustomerWorkoutDay=<?php echo $plan['DayOfWeekValue'] ?>&WorkoutId=<?php echo $fetch_workout_plan['data']['CustomerWorkoutData'][0]['WorkoutData'][0]['CustomerWorkoutId'] ?>" class="btn btn-dark btn-info ml-auto">
                                            <i class="ni ni-chevron-right"></i>
                                        </a>

                                    </div>
                                    <div class="card-body">
                                        <p class="card-text"> <b> <?php echo $plan['CustomerWorkoutNames'] ?> </b> </p>
                                    </div>
                                </div>
                              </div>
                            <?php } ?>
