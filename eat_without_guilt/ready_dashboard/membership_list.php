          ...
          foreach($membership_plan['data']['MembershipPlans'] as $membership_obj){  ?>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="card border m-lg-30" style="margin-bottom:30px">
                                <!-- <?php // if ( $membership_obj['MembershipPlanId'] == '1708'){ ?>
                                  <img src="img/plan_1708.jpg" class="card-img-top" alt="...">
                                <?php // } elseif ( $membership_obj['MembershipPlanId'] == '1778'){ ?>
                                  <img src="img/plan_1778.jpg" class="card-img-top" alt="...">
                                <?php // }else{ ?>
                                ...
                                <?php // } ?> -->
                                  ...
                                  <div class="card-body">
                                      ...
                                      <a href="order_summary.php?UserId=<?php echo $cust_user_id ?>&MembershipId=<?php echo $membership_obj['MembershipPlanId']; ?>" class="btn btn-primary text-center"> Buy Now </a>
                                  </div>
                                  <ul class="list-group list-group-flush">
                                      ...
                                      <li class="list-group-item"> <b> Total Price : </b> ₹ <?php echo $membership_obj['TotalPrice']; ?> <br> </li>
