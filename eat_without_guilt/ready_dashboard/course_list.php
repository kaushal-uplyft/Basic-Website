                      ...
                      <?php
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12" style="margin-top:20px;">
                          <div class="card border m-lg-30" style="margin-bottom:30px">
                            <center>
                              <img src="<?php echo $course_obj['CourseImage'] ?>" class="card-img-top" style="height:215px;width:215px;" alt="...">
                            </center>
                              <div class="card-body">
                                  <h5 class="card-title"> <b> <?php echo $course_obj['CourseName']; ?> </b> </h5>
                                  <a href="course_detail.php?course_id=<?php  echo $course_obj['CourseId']; ?>" class="btn btn-primary text-center"> View </a>
                              </div>
                              <ul class="list-group list-group-flush">
                                  ...
                                  <li class="list-group-item"> <b> Price : </b>  <?php if($course_obj['CourseType'] == 'PAD'){  ?> ₹ <?php if($course_obj['CourseDiscountedAmt']){ ?> <?php echo $course_obj['CourseDiscountedAmt'] ?> <?php } else { ?> <?php echo $course_obj['CourseAmount'] ?> <?php } ?> <?php } else { ?> Free  <?php } ?>  </li>
                                  <li class="list-group-item"> <b> Validity : </b>  <?php if($course_obj['Validity']) { ?> <?php  echo $course_obj['Validity']; ?> <?php } else{ ?> Lifetime <?php } ?> </li>
                              </ul>
                              <!-- <div class="card-body">
                        ...
                        <div class="col-md-12">
                          <div class="panel-hdr" style="margin-top:30px;">
                              <h2 style="text-align:center">
                                No course available to purchase. 
                              </h2>
                          </div>
                        </div>
