...
<?php
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "https://www.dev.uplyftinnovations.com/api/v1/membership-plans/",
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>
            Cards - UI Components - SmartAdmin v4.0.0
        </title>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="card border m-lg-30" style="margin-bottom:30px">
                                  ...
                                  <div class="card-body">
                                      ...
                                      <p class="card-text"> Description : <?php echo $membership_obj['PLanDescription']; ?> </p>
                                      <a href="order_summary.php?UserId=2100&MembershipId=<?php echo $membership_obj['MembershipPlanId']; ?>" class="btn btn-primary text-center"> Buy Now </a>
                                  </div>
                                  <ul class="list-group list-group-flush">
                                      <li class="list-group-item"> Category : <?php echo $membership_obj['Category']; ?>    </li>
                                      <li class="list-group-item"> Duration : <?php echo $membership_obj['PlanPeriodUnits']; ?>  <?php echo $membership_obj['PlanPeriodLength']; ?>   </li>
                                      <li class="list-group-item">  GST Type : <?php echo $membership_obj['GstText']; ?> </li>
                                      <li class="list-group-item"> Price : <?php echo $membership_obj['PlanPrice']; ?> </li>
                                      <li class="list-group-item"> Discounted Price : <?php echo $membership_obj['DiscountPrice']; ?> </li>
                                      <li class="list-group-item"> Total Price : <?php echo $membership_obj['TotalPrice']; ?> </li>
                                      <li class="list-group-item"> Terms And Conditions : <?php echo $membership_obj['PlanTermsConditions']; ?> </li>
                                  </ul>
                                  <!-- <div class="card-body">
