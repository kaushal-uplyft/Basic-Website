                        ...
                        <div class="container py-4 py-lg-5 my-lg-5 px-4 px-sm-0">
                            <div class="row">
                                <div class="col col-md-6 col-lg-7 hidden-sm-down">
                                    <h2 class="fs-xxl fw-500 mt-4" style="color:#000">
                                        About Us
                                        ...
                                        <p class="h3 fw-300 mt-3 mb-5 text-black" style="color:#000"> <?php echo $about_us_text ?> </p>
                                    </h2>
                                    <a href="<?php echo $about_us ?>" target="_blank" class="fs-lg fw-500 opacity-70" style="color:#000">Learn more &gt;&gt;</a>
                                    <!-- <div class="d-sm-flex flex-column align-items-center justify-content-center d-md-block">
                                        <div class="px-0 py-1 mt-5 text-white fs-nano opacity-50">
                                            Find us on social media
                                        </div>
                                        <div class="d-flex flex-row opacity-70">
                                            <a href="https://www.facebook.com/childyogis" target="_blank" class="mr-2 fs-xxl text-white">
                                                <i class="fab fa-facebook-square"></i>
                                            </a>
                                            <a href="https://twitter.com/ChildYogis" target="_blank" class="mr-2 fs-xxl text-white">
                                                <i class="fab fa-twitter-square"></i>
                                            </a>
                                            <a href="https://childyogis.blogspot.com/" target="_blank" class="mr-2 fs-xxl text-white">
                                                <i class="fab fa-google-plus-square"></i>
                                            </a>
                                            <a href="https://www.instagram.com/childyogis/" target="_blank" class="mr-2 fs-xxl text-white">
                                    ...
                                    <div class="card p-4 rounded-plus bg-faded">
                                        <form id="js-login" novalidate="" action="user_login.php">
                                            <div class="form-group row">
                                                <label class="col-xl-12 form-label" for="username">Username</label>
                                                <div class="col-4">
                                            ...
                                            <div class="container-code">
                                              ...
                                              <button type="button" onclick="phoneAuth();" class="form-control" title="Send OTP">Send OTP</button><br>
                                            </div>
                                            <div class="container_verify">
                                            <input type="text" id="verificationCode" placeholder="Enter verification code" class="form-control"><br>
                                            <button type="button" onclick="codeverify();" class="form-control" title="Verify OTP">Verify OTP</button>
                                          </div>
                                            <!--  Delete LAter -->
