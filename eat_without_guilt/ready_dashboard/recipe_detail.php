...
<?php
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => $api_endpoint."api/v1/reciepe-details/",
      ...
      CURLOPT_POSTFIELDS => "MasterItemId=$master_id",
        ...
        <!-- BEGIN Page Wrapper -->
            <?php include 'navbar.php';?>
                    <main id="js-page-content" role="main" class="page-content">
                      ...
                      <div class="panel-hdr">
                          <h2>
                            Recipe  -  <?php print_r($recipe_detail['data']['DietList'][0]['ItemName']) ?>
                          </h2>
                      ...
                      <div class="col-md-12 col-xs-12">
                        <div class="card border m-lg-30" style="margin-bottom:30px">
                            ...
                            <?php if($recipe_detail['data']['DietList'][0]['VideoLink']) { ?>
                            <!-- <video controls>
                                <source src="<?php // echo $recipe_detail['data']['DietList'][0]['VideoLink'] ?>" type="video/mp4">
                                Your browser does not support the video tag.
                            </video> -->


                            <?php if(strpos($recipe_detail['data']['DietList'][0]['VideoLink'], 'youtube.com/watch') !== false){
                                $video_id = explode('=',$recipe_detail['data']['DietList'][0]['VideoLink']);
                                $video_link = "https://www.youtube.com/embed/".$video_id[1];
                              }elseif(strpos($recipe_detail['data']['DietList'][0]['VideoLink'], 'youtu.be') !== false){
                              $video_id = explode('.be/',$recipe_detail['data']['DietList'][0]['VideoLink']);
                              $video_link = "https://www.youtube.com/embed/".$video_id[1];
                              }
                              else{
                                $video_link = $recipe_detail['data']['DietList'][0]['VideoLink'];
                              }
                               ?>
                          ...
                          <?php } else {?>
                            <img src="<?php echo $recipe_detail['data']['DietList'][0]['Image'] ?>" class="card-img-top" alt="...">
                          <?php } ?>
                            <div class="card-body">
                                <h5 class="card-title"> <b> <?php echo $recipe_detail['data']['DietList'][0]['ItemName'] ?> </b> </h5>
                                <?php if($recipe_detail['data']['DietList'][0]['Notes']) { ?>
                                <p class="card-text"> <b> Notes : </b> <br> <?php echo $recipe_detail['data']['DietList'][0]['Notes'] ?> </p>
                              <?php } ?>

                              <?php if($recipe_detail['data']['DietList'][0]['PrepTime']) { ?>
                                <p class="card-text"> <b> Preparation Time : </b>  <?php echo $recipe_detail['data']['DietList'][0]['PrepTime'] ?> Mins </p>
                              <?php } ?>

                              <?php if($recipe_detail['data']['DietList'][0]['PDFLink']) { ?>
                                <a class="card-text" href="<?php echo $recipe_detail['data']['DietList'][0]['PDFLink'] ?>"> View Recipe PDF </a>
                              <?php } ?>
                            </div>
                            <!-- <div class="card-body">
