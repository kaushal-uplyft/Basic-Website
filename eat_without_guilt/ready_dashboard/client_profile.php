                              ...
                              <div class="card mb-g rounded-top">
                                  <div class="row no-gutters row-grid">
                                    <div class='bg_layer col-12'>
                                      <div class="customer_cover_pic" style="background:url('<?php echo $customer_info['data']['CustomerCoverPic'] ?>');background-repeat: no-repeat;background-position: center;background-size: cover;" >
                                          <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                              <img src="<?php echo $customer_info['data']['CustomerProfilePic'] ?>" height="120" width="120" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                              <h5 class="mb-0 fw-700 text-white text-center mt-3">
                                                  <?php echo $customer_info['data']['CustomerFirstName'].' '. $customer_info['data']['CustomerLastName'] ?>
                                                  <small class="text-white mb-0"> <?php echo $customer_info['data']['CustomerEmail'] ?> </small>
                                                  <small class="text-white mb-0"> <?php echo $customer_info['data']['CustomerMobile'] ?> </small>
                                              </h5>
                                          </div>
                                      </div>
                                    </div>
                                        ...
                                        <div class="panel-container show">
                                            <div class="panel-content">
                                                ...
                                                <div class="col-md-12">
                                                  <div class="card border mb-g">
                                                      <div class="card-header bg-danger-700 pr-3 d-flex align-items-center flex-wrap">
                                                          <div class="card-title"> View Fitness Profile Form </div>
                                                ...
                                                <div class="col-md-12">
                                                  <div class="card border mb-g">
                                                      <div class="card-header bg-danger-700 pr-3 d-flex align-items-center flex-wrap">
                                                          <div class="card-title"> View Physiotheraphy Form </div>
                                                          <a href="customer_physio_form.php" class="btn btn-dark btn-info ml-auto">
                                                              <i class="ni ni-chevron-right"></i>
                                                          </a>
                                                ...
                                                <div class="col-md-12">
                                                  <div class="card border mb-g">
                                                      <div class="card-header bg-danger-700 pr-3 d-flex align-items-center flex-wrap">
                                                          <div class="card-title"> Fitness Center Info </div>
                                                          <a href="fitness_center_info.php" class="btn btn-dark btn-info ml-auto">
                                                              <i class="ni ni-chevron-right"></i>
                                                          </a>
                                      ...
                                      <!-- <div class="row"> -->
                                        <div class="col-3">
                                            <div class="text-center py-3">
                                                <h5 class="mb-0 fw-700">
                                                    764
                                                    <small class="text-muted mb-0"> Posts </small>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                        ...
                                        <div class="col-3">
                                            <div class="text-center py-3">
                                                <h5 class="mb-0 fw-700">
                                                  <?php if($customer_info['data']['TotalCheckins']) { ?>  <?php echo $customer_info['data']['TotalCheckins'] ?> <?php } else{ ?> -- <?php } ?>
                                                    <small class="text-muted mb-0"> Check Ins </small>
                                                </h5>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="text-center py-3">
                                                <h5 class="mb-0 fw-700">
                                                  <?php if($customer_info['data']['CustomerGender']) { ?>  <?php echo $customer_info['data']['CustomerGender'] ?> <?php } else{ ?> -- <?php } ?>
                                        ...
                                        <div class="col-4">
                                            <div class="text-center py-3">
                                                <h5 class="mb-0 fw-700">
                                                   <?php if($customer_info['data']['CustomerDOB']) { ?>  <?php echo $customer_info['data']['CustomerDOB'] ?> <?php } else{ ?> -- <?php } ?>
                                                    <small class="text-muted mb-0"> Birthday </small>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="text-center py-3">
                                                <h5 class="mb-0 fw-700">
                                                  <?php if($customer_info['data']['CustomerGoal']) { ?>  <?php echo $customer_info['data']['CustomerGoal'] ?> <?php } else{ ?> -- <?php } ?>
                                                    <small class="text-muted mb-0"> Goal </small>
                                                </h5>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="text-center py-3">
                                                <h5 class="mb-0 fw-700">
                                                  <?php if($customer_info['data']['CustomerWeightKg']) { ?>  <?php echo $customer_info['data']['CustomerWeightKg'] ?> <?php } else{ ?> -- <?php } ?>
                                                    <small class="text-muted mb-0"> Weight </small>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="text-center py-3">
                                                <h5 class="mb-0 fw-700">
                                                  <?php if($customer_info['data']['CustomerHeight']) { ?>  <?php echo $customer_info['data']['CustomerHeight'] ?> <?php } else{ ?> -- <?php } ?>
                                                    <small class="text-muted mb-0"> Height </small>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="text-center py-3">
                                                <h5 class="mb-0 fw-700">
                                                  <?php if($customer_info['data']['CustomerLevel']) { ?>  <?php echo $customer_info['data']['CustomerLevel'] ?> <?php } else{ ?> -- <?php } ?>
                                                    <small class="text-muted mb-0"> Level </small>
                                                </h5>
                                            </div>
                                        </div>
                                      <!-- </div> -->
