...
<?php
  ...
  $workout_day = $_GET['CustomerWorkoutDay'];
...
<?php
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => $api_endpoint."api/v1/fetch-customer-workout-exercise/",
      ...
      CURLOPT_POSTFIELDS => "CustomerUserId=$cust_user_id&CustomerWorkoutDay=$workout_day",
    ...
    $err = curl_error($curl);
    curl_close($curl);
    $customer_workout_exercise =  json_decode($response, true);
                    ...
                    <div id="panel-9" class="panel">
                      <div class="panel-container show">
                          <div class="panel-content">
                              ...
                              <?php
                              foreach($customer_workout_exercise['data']['RoundInfo'] as $round) { ?>
                                <?php if($round['RoundName']){ ?>
                                  <div class="panel-tag">
                                      <?php echo $round['RoundName'] ?>
                                  </div>
                                <?php } else{ ?>
                                  <!-- <div class="panel-tag">
                                      Uncategorized
                                  </div> -->
                                <?php }  ?> <!-- else condition end -->
                              <?php // } ?> <!-- Round Info End -->
                              <div class="row">
                              <?php
                              foreach($customer_workout_exercise['data']['CustomerWorkoutExercise'] as $exercise) { ?>
                              <?php  if($exercise['CustomerRoundUnit'] == $round['RoundName']){ ?>
                              <div class="col-md-12">
                                <div class="card border mb-g">
                                    <div class="card-header bg-danger-700 pr-3 d-flex align-items-center flex-wrap">

                                        <?php if($exercise['VideoThumbnail']){ ?>
                                          <img src="<?php echo $exercise['VideoThumbnail'] ?>" style="width:100px;height:100px" class="card-img-top" alt="...">
                                        <?php } else { ?>
                                          <img src="<?php echo $exercise['ExerciseGif'] ?>" style="width:100px;height:100px" class="card-img-top" alt="...">
                                        <?php } ?>
                                        <div class="card-title" style="margin-left:30px;"> <?php echo $exercise['CustomerWorkoutExercise'] ?></div>

                                        <a href="customer_single_exercise.php?CustomerWorkoutExerciseId=<?php echo $exercise['CustomerWorkoutExerciseId']; ?>&WorkoutId=<?php echo $exercise['CustomerWorkoutId']?>&SetType=<?php echo $exercise['SetType']; ?>" class="btn btn-dark btn-info ml-auto">
                            ...
                            <?php } ?>  <!-- Round and exercise match if cond -->
