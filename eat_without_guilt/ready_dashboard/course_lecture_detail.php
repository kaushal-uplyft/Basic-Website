                              ...
                              <div class="col-md-12">
                                <div class="card border mb-g">
                                    <div class="card-header bg-danger-700 pr-3 d-flex align-items-center flex-wrap">
                                        ...
                                        <?php if($section['VideoThumbnail']){ ?>
                                          <img src="<?php echo $section['VideoThumbnail'] ?>" style="width:100px;height:100px" class="card-img-top" alt="...">
                                        <?php } else { ?>
                                          <img src="<?php echo $section['ExerciseGif'] ?>" style="width:100px;height:100px" class="card-img-top" alt="...">
                                        <?php } ?>
                                        <div class="card-title" style="margin-left:30px;"> <?php echo $section['SectionName'] ?></div><br>
