...
// if (!isset($_POST['save'])){
  ...
  // $image_one_str = file_get_contents($image_one);
  // $image_one_base_code = base64_encode($image_one_str);
  ...
  curl_setopt_array($curl, array(
    ...
    CURLOPT_POSTFIELDS => "CheifComplain=$chief_complain&ProblemDuration=$when_problem_start&HowStart=$how_problem_start&PainGrade=$pain_value&Note=$notes&PhysioId=$physio_id&Extension='jpg'&ImageOne=''&ImageTwo=''&ImageThree=''&ImageFour=''&CustomerUserId=$cust_user_id",
