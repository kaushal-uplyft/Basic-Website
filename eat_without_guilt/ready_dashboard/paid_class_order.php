            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					<form action="paid_class_order.php?UserId=<?php echo $CustomerUserId; ?>&MembershipId=<?php echo $MembershipPlanId; ?>&BatchId=<?php echo $class_id; ?>&SubscriptionStartDate=<?php echo $record_date ?>&ClassMembershipType=$MembershipType" method="post" id="price_summary" class="form-horizontal form-label-left">
    ...
    if (!empty($_POST)) {
      ...
      if($razarpay_info['action_type']=="proceed_to_payment"){
        ...
        curl_setopt_array($curl, array(
          ...
          // CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
          CURLOPT_CUSTOMREQUEST => "POST",
          CURLOPT_POSTFIELDS => "CustomerUserId=$CustomerUserId&MembershipPlanId=$MembershipPlanId&PaymentType=OL&ClassId=$class_id&SubscriptionStartDate=$record_date&ClassMembershipType=$MembershipType",
          CURLOPT_HTTPHEADER => array(
            'content-type: application/x-www-form-urlencoded',
            'Authorization:'.$auth_key,
          ),
