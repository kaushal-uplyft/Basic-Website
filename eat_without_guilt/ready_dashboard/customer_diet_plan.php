...
<?php
  ...
  for ($d = 1; $d <= 7; $d++) {
      ...
      $dates[$dt->format('l')] = $dt->format('Y-m-d');
      // $dates[$dt->format('W')] = $dt->format('Y-m-d');
  }
// print_r($dates);
  if($cust_user_id){
  }
...
<?php
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => $api_endpoint."api/v1/trainer-diet-days/",
            ...
            <?php include 'navbar.php';?>
                  <main id="js-page-content" role="main" class="page-content">
                    <div class="panel-hdr">
                        ...
                        <h2>
                          Created By :  <?php echo  $customer_diet_plan['data']['CreatedBy'] ?>
                        </h2>

                        <h2>
                          Assigned On : <?php echo  $customer_diet_plan['data']['AssignedDate'] ?>
                        </h2>
                    ...
                    <div id="panel-9" class="panel">
                      <div class="panel-container show">
                          <div class="panel-content">
                              ...
                              <div class="col-md-12 calories">
                                  <div class="row m-0">
                                      <div class="col-md-12" style="margin-bottom:15px;">
                                          ...
                                          <p class="two"><strong><?php echo $customer_diet_plan['data']['TotalCalories'] ?> kcal</strong></p>
                                      ...
                                      <div class="col-md-3 categories text-center">
                                          ...
                                          <p class="first" style="margin-top:10px;font-weight:bold;"><?php echo $customer_diet_plan['data']['TotalProteins'] ?> gm</p>
                                      </div>
                                      <div class="col-md-3 categories text-center">
                                          <span> <img src="img/quick_action/carbs.png" alt=""style="margin-bottom:10px;"><br> Carbs </span>
                                          <p class="second" style="margin-top:10px;font-weight:bold;"><?php echo $customer_diet_plan['data']['TotalCarbs'] ?> gm</p>
                                      </div>
                                      <div class="col-md-3 categories text-center">
                                          <span> <img src="img/quick_action/fats.png" alt="" style="margin-bottom:10px;"><br> Fats </span>
                                          <p class="third" style="margin-top:10px;font-weight:bold;"><?php echo $customer_diet_plan['data']['TotalFats'] ?> gm</p>
                                      </div>
                                      <div class="col-md-3 categories text-center">
                                          <span> <img src="img/quick_action/fiber.png" alt="" style="margin-bottom:10px;"><br> Fibers</span>
                                          <p class="fourth" style="margin-top:10px;font-weight:bold;"><?php echo $customer_diet_plan['data']['TotalFibers'] ?> gm</p>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="row">
                              <?php
                              foreach($customer_diet_plan['data']['DietPlanDays'] as $plan) { ?>
                              <div class="col-md-12">
                                <div class="card border mb-g">
                                    <div class="card-header bg-danger-700 pr-3 d-flex align-items-center flex-wrap">
                                        <div class="card-title"> Calories : <?php echo $plan['Calories'] ?> Kcal </div>
                                        <a href="customer_diet_meal.php?RecordDate=<?php echo $dates[$plan['DayName']] ?>&DayId=<?php echo $plan['DayId'] ?>&DayName=<?php echo $plan['DayName'] ?>" class="btn btn-dark btn-info ml-auto">
                                            <i class="ni ni-chevron-right"></i>
                                        </a>

                                    </div>
                                    <div class="card-body">
                                        <p class="card-text"> <b> <?php echo $plan['DayName'] ?> </b> </p>
                                        <p class="card-text"> <b> <?php echo $dates[$plan['DayName']] ?> </b> </p>
                                    </div>
                                </div>
                              </div>
                            <?php } ?>
