...
// if (!empty($_POST)) {
  ...
  if ($apply_filter == 'Next'){
    $current_page_no = (int)$current_page_no + 1;
  }

  if ($apply_filter == 'Back'){
    $current_page_no = (int)$current_page_no - 1;
    if($current_page_no == '' or $current_page_no == 0){
      $current_page_no = 1;
    }
  }
                          ...
                          <nav aria-label="Page navigation example">
                              <ul class="pagination">
                                ...
                                <input type="hidden" name="next_page" value="<?php// echo $next_page ?>"> -->
                                  <li class="page-item"> <input type="submit" name="apply_filter" value="Back" class="page-link text-center"> </li>
                                  <li class="page-item active" aria-current="page">
                                      <input type="text" name="current_page" value="<?php echo $current_page_no ?>" readonly class="page-link text-center">
                                  </li>
                                  <li class="page-item"> <input type="submit" name="apply_filter"  value="Next" class="page-link text-center"> </li>
                              </ul>
                          </nav>
                        </div>
                      </form>
