                            ...
                            <div id="panel-1" class="panel">
                                ...
                                <div class="panel-container show">
                                    <div class="panel-content">
                                        <div class="panel-tag">
                                            To browse classes, please select the preferred day on which you wish to book a class & click on Submit.
                                        </div>
                                           ...
                                           <div class="col-md-6 col-sm-6 col-xs-12">
                                             ...
                                             <?php } ?>
                                                 ...
                                                 <ul class="list-group list-group-flush">
                                                     ...
                                                     <li class="list-group-item"> Slots Remaining : <?php  echo $class_obj['MembershipName']; ?>    </li>
                                       ...
                                       <?php  }?>
                                     <?php  }else{ ?>
                                      <h1> No Class Found For the Selected Date </h1>
                                     <?php } ?>
