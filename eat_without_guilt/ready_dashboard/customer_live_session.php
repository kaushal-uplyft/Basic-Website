...
<?php
  ...
  $live_session_id = $_GET['live_session_id'];
...
<?php
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => $api_endpoint."api/v1/join-live-sessions/",
      ...
      CURLOPT_POSTFIELDS => "LiveSessionId=$live_session_id&CustomerUserId=$cust_user_id",
    ...
    $err = curl_error($curl);
    curl_close($curl);
    $session_detail =  json_decode($response, true);
    // echo "<script> alert($session_detail); </script>";
    // if ($session_detail['status_code'] == '200' ){
    //   echo "<script> alert('*** session join ***'); </script>";
    // }
...
<html lang="en">
                      ...
                      <div class="">
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                            <form action="." method="post" id="noti_list" class="form-horizontal form-label-left" enctype="multipart/form-data">
                              <div class="x_title">
                                <h2>Live Session <small>Video</small></h2>
                                <div class="clearfix"></div>
                              </div>
                              <div class="x_content">
                                  <div id="meet"> </div>
    ...
    $(document).ready(function () {
        ...
        //         TOOLBAR_BUTTONS: ['hangup', 'microphone', 'camera', 'fullscreen', 'filmstrip','chat']
        //     },
        //     configOverwrite: {
        //         enableClosePage: true
        //     },
        //     // userInfo: {
        //     //     displayname: '{{start_session_user_name}}'
        //     // }1
        // };
        const options = {
        ...
        api.on('readyToClose', () => {
            api.dispose();
            // location.replace('http://localhost:8000/trainer-dashboard/end-live/{{live_session_id}}/');
