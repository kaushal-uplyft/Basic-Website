...
// if (!empty($_POST)) {
  ...
  // echo "<script> alert('** apply filter **'+$apply_filter+'** current page **'+$current_page_no) </script>";
  echo "<script> alert('** apply filter **'+$current_page_no) </script>";
}
?>
...
<?php
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => $api_endpoint."api/v1/diet-item-listing/",
      ...
      CURLOPT_POSTFIELDS => "CustomerUserId=$cust_user_id&PageNo=$current_page_no&MealId=1&IsRecipe=1",
                    ...
                    <div id="panel-9" class="panel">
                      <div class="panel-container show">
                          <div class="panel-content">
                              ...
                              <div class="row">
                              <?php
                              foreach($customer_diet_plan['data']['DietList'] as $plan) { ?>
                              <div class="col-md-12">
                                <div class="card border mb-g">
                                    <div class="card-header bg-danger-700 pr-3 d-flex align-items-center flex-wrap">
                                        <img src="<?php echo $plan['Image'] ?>" style="width:100px;height:100px;margin-right:30px;" class="card-img-top" alt="...">

                                        <div class="card-title"> <?php echo $plan['ItemName'] ?> </div>
                                        <a href="recipe_detail.php?MasterItemId=<?php echo $plan['MasterItemId'] ?>" class="btn btn-dark btn-info ml-auto">
                                            <i class="ni ni-chevron-right"></i>
                                        </a>

                                    </div>
                                    <div class="card-body">
                                        <p class="card-text"> <b> Preparation Time : <?php echo $plan['PrepTime'] ?> Mins </b> </p>
                                        <p class="card-text"> <b> Calories : <?php echo $plan['Calories'] ?> </b> </p>
                                    </div>
                                </div>
                              </div>
                            <?php } ?>
                          ...
                          <!-- <form action="receipe_list.php" method="post" id="receipe_list" class="form-horizontal form-label-left" enctype="multipart/form-data"> -->
                          <form id="js-login" novalidate="" action="receipe_list.php" method="POST" enctype="multipart/form-data">
                          <div class="text-center" style="position:relative;left:45%;">
                          <nav aria-label="Page navigation example">
                              <ul class="pagination">
                                ...
                                <input type="hidden" name="next_page" value="<?php// echo $next_page ?>"> -->
                                  <li class="page-item"> <input type="submit" name="apply_filter" value="Back"> </li>
                                  <li class="page-item active" aria-current="page">
                                      <!-- <a class="page-link" name="current_page" value="<?php echo $current_page_no ?>"> <?php echo $current_page_no ?> <span class="sr-only">(current)</span></a> -->
                                      <input type="text" name="current_page" value="<?php echo $current_page_no ?>" readonly class="page-link text-center">
                                  </li>
                                  <li class="page-item"> <input type="submit" name="apply_filter"  value="Next"> </li>
                              </ul>
                          </nav>
                        </div>
                      </form>
