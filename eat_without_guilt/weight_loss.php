...
<div id="mySidenav" class="sidenav">
    ...
    <div class="col-md-12 row text-center">
        ...
        <form method="get" action="#" id="form_register" autocomplete="off" style="margin-top: 0px !important;">
            <input type="hidden" name="csrfmiddlewaretoken" value="DpmTiqJnBPAuO1iJT6jueupBA3xCT2if1uPQ4RWCVTi3TlP2hQkkt5fiifXsQAq2">
...
<!--    <div class="preloader"></div>-->
    ...
    <section class="page-title" style="padding-top:150px"><div class="auto-container"><h2 class="text-white font-medium" style="max-width: 500px">Weight Loss Program </h2></div>
    </section>
<!--
    <div class="preloader" id="overlay" style="z-index: 10000000000">
        <div class="loader"><div class="loader__figure" style="">
            </div>
            <H4 class="loader__label" style="color:white;">
            PLEASE WAIT.... 
            </H4>
        </div>
    </div>
-->
    <!--Page Info--><section class="page-info"><div class="auto-container clearfix"><div class="breadcrumb-outer"><ul class="bread-crumb clearfix"><li><a href="index.html">Home</a></li><li class="active">Weight Loss Program </li></ul></div></div></section><div class="sec-title centered bg-white m-t-5"><h3 class="font-medium">Plans & Pricing</h3></div><section class="price-plans m-t-5"><div class="auto-container"><div class="row clearfix price_listing text-center " style="margin-top: 30px;"><div class="text-center" style="margin: auto;"><!--Price Column--><div class="pricing-column" style="width:250px;margin-right: 20px;display:inline-block"><div class="inner-box wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms"
                                 style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;"><div class=""></div><div class="pricing-info clearfix"><div class="duration">7 Days </div><div class="price styled-font" style="font-size: 16px;"><span
                                            style="font-size: 12px;">INR</span><span>0</span></div></div><div class="lower-content"><input type="hidden" name="csrfmiddlewaretoken" value="DpmTiqJnBPAuO1iJT6jueupBA3xCT2if1uPQ4RWCVTi3TlP2hQkkt5fiifXsQAq2"><div class="link-box"><input value="0" class="pack_price" hidden><a
                                            type="button" class="pay_btn btn bg-primary" data-price="0"
                                            data-coupon=""
                                            data-duration="7"
                                    >Pay
                                 ...
                                 style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;"><div class=""></div><div class="pricing-info clearfix"><div class="duration">1 month</div><div class="price styled-font" style="font-size: 16px;"><span
                                            style="font-size: 12px;">INR</span><span>3000</span></div></div><div class="lower-content"><input type="hidden" name="csrfmiddlewaretoken" value="DpmTiqJnBPAuO1iJT6jueupBA3xCT2if1uPQ4RWCVTi3TlP2hQkkt5fiifXsQAq2"><div class="link-box"><input value="3000" class="pack_price" hidden><a
                                            type="button" class="pay_btn btn bg-primary" data-price="3000"
                                            data-coupon=""
                                            data-duration="30"
                                    >Pay
                                        Now</a><span style="cursor: pointer; text-decoration: underline;
                                    ...
                                    font-size: 10px; display: none" class="cpnApplied">Promo Code Applied</span></div></div></div></div><div class="pricing-column" style="width:250px;margin-right: 20px;display:inline-block"><div class="inner-box wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms"
                                 style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;"><div class=""></div><div class="pricing-info clearfix"><div class="duration">2 month</div><div class="price styled-font" style="font-size: 16px;"><span
                                            style="font-size: 12px;">INR</span><span>5000</span></div></div><div class="lower-content"><input type="hidden" name="csrfmiddlewaretoken" value="DpmTiqJnBPAuO1iJT6jueupBA3xCT2if1uPQ4RWCVTi3TlP2hQkkt5fiifXsQAq2"><div class="link-box"><input value="5000" class="pack_price" hidden><a
                                            type="button" class="pay_btn btn bg-primary" data-price="5000"
                                            data-coupon=""
                                            data-duration="60"
                                    >Pay
                                        Now</a><span style="cursor: pointer; text-decoration: underline;
                                    ...
                                    font-size: 10px; display: none" class="cpnApplied">Promo Code Applied</span></div></div></div></div><div class="pricing-column" style="width:250px;margin-right: 20px;display:inline-block"><div class="inner-box wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms"
                                 style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;"><div class=""></div><div class="pricing-info clearfix"><div class="duration">3 month</div><div class="price styled-font" style="font-size: 16px;"><span
                                            style="font-size: 12px;">INR</span><span>6500</span></div></div><div class="lower-content"><input type="hidden" name="csrfmiddlewaretoken" value="DpmTiqJnBPAuO1iJT6jueupBA3xCT2if1uPQ4RWCVTi3TlP2hQkkt5fiifXsQAq2"><div class="link-box"><input value="6500" class="pack_price" hidden><a
                                            type="button" class="pay_btn btn bg-primary" data-price="6500"
                                            data-coupon=""
                                            data-duration="90"
                                    >Pay
                                        Now</a><span style="cursor: pointer; text-decoration: underline;
                                    font-size: 10px; display: block" class="hvCpn" id="pBox_3">Have a Coupon Code</span><span style=" color: green;
                                    font-size: 10px; display: none" class="cpnApplied">Promo Code Applied</span></div></div></div></div><div class="alert form-group padd-top-15 col-md-12 text-center"><h3 class="message" style="color:#2aa07d"></h3></div></div></div></div></section><!--Sidebar Page--><div class="auto-container"><div class="row clearfix"><!--Content Side--><div class="content-side col-lg-12 col-md-8 col-sm-12 col-xs-12"><!--Blog Details--><section class="blog-details post-details"><div class="news-style-one"><div class="inner-box"><div class="lower-content"><br><h3><span class="b-b font-medium">Description</span></h3><br><div class="text text-content"><p>One of the golden rules of having a healthy body is by having your body weight in proportion to your height , gender and age category.&nbsp;</p><p>Firstly, we understand the reason &nbsp;for &nbsp;increased &nbsp;weight it can be because of be &nbsp;underlying disease, &nbsp;bad lifestyle and genetics . &nbsp;We don't believe in &nbsp;crash diets instead of that we change your daily diet pattern and include small challenges for you . &nbsp;Diet plans &nbsp;are planned according to your lifestyle &nbsp;and needs. &nbsp;We try that our clients don't feel &nbsp;like they are on diet by including food they love.</p><p>We aim for weight loss upto 5kg &nbsp;a month but how much you lose depends on &nbsp;your body type . &nbsp;We provide one to one consultation on &nbsp;phone &nbsp;with DT ADITI and DT SURBHI. &nbsp;we will be there to help you throughout your weight loss journey</p><p>&nbsp;</p></div><div class="post-bottom clearfix"></div></div></div></div><!--Comments Area--></section></div><!--End Content Side--></div></div><div class="modal fade" id="exampleModals1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         ...
         aria-hidden="true"><div class="modal-dialog modal-sm" role="document"><div class="modal-content"><div class="modal-header"><h6 class="modal-title" id="modal-title-notification">Apply Promo Code</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="$('#coupon_error').html('');
                        $('#coupon_code').val('');"><span aria-hidden="true">×</span></button></div><div class="modal-body"><form id="couponForm"><div class="form-group"><div class="form-group" style="display: flex"><input class="form-control form-control-sm"
                                ...
                                /><button type="submit"
                                     ...
                                     color: white;">apply
                                </button><input type="hidden" name="csrfmiddlewaretoken" value="DpmTiqJnBPAuO1iJT6jueupBA3xCT2if1uPQ4RWCVTi3TlP2hQkkt5fiifXsQAq2"></div><input type="hidden" name="programId" value="488" id="programId" required><input type="hidden" name="duration" value="" id="pg_duration" required><div id="coupon_error" style="text-align: center; color: red; font-size: 10px;"></div></div></form></div></div></div></div>
...
<script>
    ...
    <script type='text/javascript'>
        var p_name = "Weight Loss Program "
        var p_id = "488"
