...
<div id="mySidenav" class="sidenav">
    ...
    <div class="col-md-12 row text-center">
        ...
        <form method="get" action="#" id="form_register" autocomplete="off" style="margin-top: 0px !important;">
            <input type="hidden" name="csrfmiddlewaretoken" value="9KlY4tsoGdvGG2k5ZRUCrtgz5iwUvYO4xPOVQUFD0hdfLmRonBVsG46gNuWKswWR">
...
<!--    <div class="preloader"></div>-->
    ...
    <section class="page-title" style="padding-top:150px"><div class="auto-container"><h2 class="text-white font-medium" style="max-width: 500px">Weight Gain Program </h2></div>
    </section>
<!--
    <div class="preloader" id="overlay" style="z-index: 10000000000">
        <div class="loader">
...
-->
    <!--Page Info-->
    <section class="page-info"><div class="auto-container clearfix"><div class="breadcrumb-outer"><ul class="bread-crumb clearfix"><li><a href="index.html">Home</a></li><li class="active">Weight Gain Program </li></ul></div></div></section><div class="sec-title centered bg-white m-t-5"><h3 class="font-medium">Plans & Pricing</h3></div><section class="price-plans m-t-5"><div class="auto-container"><div class="row clearfix price_listing text-center " style="margin-top: 30px;"><div class="text-center" style="margin: auto;"><!--Price Column--><div class="pricing-column" style="width:250px;margin-right: 20px;display:inline-block"><div class="inner-box wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms"
                                 style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;"><div class=""></div><div class="pricing-info clearfix"><div class="duration">1 month</div><div class="price styled-font" style="font-size: 16px;"><span
                                            style="font-size: 12px;">INR</span><span>3000</span></div></div><div class="lower-content"><input type="hidden" name="csrfmiddlewaretoken" value="9KlY4tsoGdvGG2k5ZRUCrtgz5iwUvYO4xPOVQUFD0hdfLmRonBVsG46gNuWKswWR"><div class="link-box"><input value="3000" class="pack_price" hidden><a
                                 ...
                                 style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;"><div class=""></div><div class="pricing-info clearfix"><div class="duration">2 month</div><div class="price styled-font" style="font-size: 16px;"><span
                                            style="font-size: 12px;">INR</span><span>5000</span></div></div><div class="lower-content"><input type="hidden" name="csrfmiddlewaretoken" value="9KlY4tsoGdvGG2k5ZRUCrtgz5iwUvYO4xPOVQUFD0hdfLmRonBVsG46gNuWKswWR"><div class="link-box"><input value="5000" class="pack_price" hidden><a
                                 ...
                                 style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;"><div class=""></div><div class="pricing-info clearfix"><div class="duration">3 month</div><div class="price styled-font" style="font-size: 16px;"><span
                                            style="font-size: 12px;">INR</span><span>6000</span></div></div><div class="lower-content"><input type="hidden" name="csrfmiddlewaretoken" value="9KlY4tsoGdvGG2k5ZRUCrtgz5iwUvYO4xPOVQUFD0hdfLmRonBVsG46gNuWKswWR"><div class="link-box"><input value="6000" class="pack_price" hidden><a
                                            type="button" class="pay_btn btn bg-primary" data-price="6000"
                                            data-coupon=""
                                            data-duration="90"
                                    >Pay
                                        Now</a><span style="cursor: pointer; text-decoration: underline;
                                    font-size: 10px; display: block" class="hvCpn" id="pBox_2">Have a Coupon Code</span><span style=" color: green;
                                    font-size: 10px; display: none" class="cpnApplied">Promo Code Applied</span></div></div></div></div><div class="alert form-group padd-top-15 col-md-12 text-center"><h3 class="message" style="color:#2aa07d"></h3></div></div></div></div></section><!--Sidebar Page--><div class="auto-container"><div class="row clearfix"><!--Content Side--><div class="content-side col-lg-12 col-md-8 col-sm-12 col-xs-12"><!--Blog Details--><section class="blog-details post-details"><div class="news-style-one"><div class="inner-box"><div class="lower-content"><br><h3><span class="b-b font-medium">Description</span></h3><br><div class="text text-content"><p>Losing weight is a tedious process but gaining weight can be equally cumbersome</p><p>Gaining weight is hampered by many factors like fast metabolism, &nbsp;certain medications, Stress , medical conditions like hypothyroidism, coeliac disease , anaemia , type 1 diabetes. poor digestion and dietary intake can also contribute to muscle loss</p><p>We usually think that weight can be increased by consuming junk food , &nbsp;foods that are very high in fat and processed food but this will only increase our fat mass which can result in many other medical conditions like cholestrol , &nbsp;pcod and other metabolic disease. So one the biggest challenge in weight gain to gain muscle mass rather than &nbsp;fat mass&nbsp;</p><p>Features of our weight gain program is</p><ul><li>Healthy weight gain focussing &nbsp;on muscle mass , not fat mass</li><li>Lifestyle and activity management</li><li>Regular follow ups &nbsp;and re-assessment</li></ul><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p></div><div class="post-bottom clearfix"></div></div></div></div><!--Comments Area--></section></div><!--End Content Side--></div></div><div class="modal fade" id="exampleModals1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         ...
         aria-hidden="true"><div class="modal-dialog modal-sm" role="document"><div class="modal-content"><div class="modal-header"><h6 class="modal-title" id="modal-title-notification">Apply Promo Code</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="$('#coupon_error').html('');
                        $('#coupon_code').val('');"><span aria-hidden="true">×</span></button></div><div class="modal-body"><form id="couponForm"><div class="form-group"><div class="form-group" style="display: flex"><input class="form-control form-control-sm"
                                ...
                                /><button type="submit"
                                     ...
                                     color: white;">apply
                                </button><input type="hidden" name="csrfmiddlewaretoken" value="9KlY4tsoGdvGG2k5ZRUCrtgz5iwUvYO4xPOVQUFD0hdfLmRonBVsG46gNuWKswWR"></div><input type="hidden" name="programId" value="489" id="programId" required><input type="hidden" name="duration" value="" id="pg_duration" required><div id="coupon_error" style="text-align: center; color: red; font-size: 10px;"></div></div></form></div></div></div></div>
...
<script>
    ...
    <script type='text/javascript'>
        var p_name = "Weight Gain Program "
        var p_id = "489"
