...
<div id="mySidenav" class="sidenav">
    ...
    <div class="col-md-12 row text-center">
        ...
        <form method="get" action="#" id="form_register" autocomplete="off" style="margin-top: 0px !important;">
            <input type="hidden" name="csrfmiddlewaretoken" value="kfkbwoItTk39sbF2Qsoo0CuNNl7wP7ZzIkN8iPVIdoLIxvclecpefdkuvxxmMF7m">
...
<!--    <div class="preloader"></div>-->
    ...
    <section class="page-title" style="padding-top:150px"><div class="auto-container"><h2 class="text-white font-medium" style="max-width: 500px">Diabetes Management</h2></div></section>
<!--
    <div class="preloader" id="overlay" style="z-index: 10000000000">
        <div class="loader"><div class="loader__figure" style=""></div>
            <H4 class="loader__label" style="color:white;">PLEASE WAIT.... </H4>
        </div>
    </div>
-->
    <!--Page Info--><section class="page-info"><div class="auto-container clearfix"><div class="breadcrumb-outer"><ul class="bread-crumb clearfix"><li><a href="/">Home</a></li><li class="active">Diabetes Management</li></ul></div></div></section><div class="sec-title centered bg-white m-t-5"><h3 class="font-medium">Plans & Pricing</h3></div><section class="price-plans m-t-5"><div class="auto-container"><div class="row clearfix price_listing text-center " style="margin-top: 30px;"><div class="text-center" style="margin: auto;"><!--Price Column--><div class="pricing-column" style="width:250px;margin-right: 20px;display:inline-block"><div class="inner-box wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms"
                                 style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;"><div class=""></div><div class="pricing-info clearfix"><div class="duration">1 month</div><div class="price styled-font" style="font-size: 16px;"><span
                                            style="font-size: 12px;">INR</span><span>3000</span></div></div><div class="lower-content"><input type="hidden" name="csrfmiddlewaretoken" value="kfkbwoItTk39sbF2Qsoo0CuNNl7wP7ZzIkN8iPVIdoLIxvclecpefdkuvxxmMF7m"><div class="link-box"><input value="3000" class="pack_price" hidden><a
                                 ...
                                 style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;"><div class=""></div><div class="pricing-info clearfix"><div class="duration">2 month</div><div class="price styled-font" style="font-size: 16px;"><span
                                            style="font-size: 12px;">INR</span><span>5000</span></div></div><div class="lower-content"><input type="hidden" name="csrfmiddlewaretoken" value="kfkbwoItTk39sbF2Qsoo0CuNNl7wP7ZzIkN8iPVIdoLIxvclecpefdkuvxxmMF7m"><div class="link-box"><input value="5000" class="pack_price" hidden><a
                                 ...
                                 style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;"><div class=""></div><div class="pricing-info clearfix"><div class="duration">3 month</div><div class="price styled-font" style="font-size: 16px;"><span
                                            style="font-size: 12px;">INR</span><span>6500</span></div></div><div class="lower-content"><input type="hidden" name="csrfmiddlewaretoken" value="kfkbwoItTk39sbF2Qsoo0CuNNl7wP7ZzIkN8iPVIdoLIxvclecpefdkuvxxmMF7m"><div class="link-box"><input value="6500" class="pack_price" hidden><a
                                    ...
                                    font-size: 10px; display: none" class="cpnApplied">Promo Code Applied</span></div></div></div></div><div class="alert form-group padd-top-15 col-md-12 text-center"><h3 class="message" style="color:#2aa07d"></h3></div></div></div></div></section><!--Sidebar Page--><div class="auto-container"><div class="row clearfix"><!--Content Side--><div class="content-side col-lg-12 col-md-8 col-sm-12 col-xs-12"><!--Blog Details--><section class="blog-details post-details"><div class="news-style-one"><div class="inner-box"><div class="lower-content"><br><h3><span class="b-b font-medium">Description</span></h3><br><div class="text text-content"><p>India has been labelled as the ‘ diabetes capital of the world ’&nbsp;</p><p>The good part is diabetes can be controlled or prevented by good dietary &nbsp;habits and staying active through out the day. &nbsp;At EAT WITHOUT GUILT we manage &nbsp;the adverse effect that this disease bring along &nbsp;like lethargy , fatigue , numbness, excessive hunger and weight gain.</p><p>We understand that apart from management through medicines . &nbsp;Connect with us &nbsp;to manage your diabetes in the most effective manner&nbsp;</p></div><div class="post-bottom clearfix"></div></div></div></div><!--Comments Area--></section></div><!--End Content Side--></div></div><div class="modal fade" id="exampleModals1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         ...
         aria-hidden="true"><div class="modal-dialog modal-sm" role="document"><div class="modal-content"><div class="modal-header"><h6 class="modal-title" id="modal-title-notification">Apply Promo Code</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="$('#coupon_error').html('');
                        $('#coupon_code').val('');"><span aria-hidden="true">×</span></button></div><div class="modal-body"><form id="couponForm"><div class="form-group"><div class="form-group" style="display: flex"><input class="form-control form-control-sm"
                                ...
                                /><button type="submit"
                                     ...
                                     color: white;">apply
                                </button><input type="hidden" name="csrfmiddlewaretoken" value="kfkbwoItTk39sbF2Qsoo0CuNNl7wP7ZzIkN8iPVIdoLIxvclecpefdkuvxxmMF7m"></div><input type="hidden" name="programId" value="491" id="programId" required><input type="hidden" name="duration" value="" id="pg_duration" required><div id="coupon_error" style="text-align: center; color: red; font-size: 10px;"></div></div></form></div></div></div></div>
...
<script>
    ...
    <script type='text/javascript'>
        var p_name = "Diabetes management"
        var p_id = "491"
